   ...
   'use strict'
    ...
    var retinaLogos = function() {
      var retina = window.devicePixelRatio > 1 ? true : false;
        if( retina ) {
            $( '.header .logo' ).find('img').attr( {src:'static/img/logo1.png',width:'156',height:'102'} );   
            $( '.title-section .icon' ).find('img').attr( {src:'static/images/icon/line@2x.png',width:'282',height:'24'} );
        }
    };    
